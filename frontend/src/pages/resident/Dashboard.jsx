...
export default function ResidentDashboard() {
 ...
 useEffect(() => {
  ...
  if (!dashboard) return <h2>خطا در دریافت اطلاعات</h2>;
  ...
  return (
    <>
      ...
      <p>
        طبقه {dashboard.profile.floorNumber} - واحد{" "}
        {dashboard.profile.unitNumber}
      </p>
      ...
      <DashboardSection title="کمپین فعال">
        ...
        {dashboard.activeCampaign ? (
          <>
            ...
            <p>
              وضعیت : {dashboard.activeCampaign.status}
            </p>
